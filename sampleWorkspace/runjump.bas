...
' First I shift the two later strings to the left (m.i+245,i+244,247:m.i+493,i+491,71) to remove the 1st byte FastBasic uses to store string lengths, so it becomes one contiguous chunk of data in memory
